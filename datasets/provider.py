...
from interfaces import IDatasetProvider, ITensorAudioDataset, ICustomDataset, IDatasetBalancer, IFeatureAccessor, ILabelAccessor
...
class VerificationDatasetProvider(IDatasetProvider):
    def __init__(
        ...
        label_accessor: ILabelAccessor) -> None:
