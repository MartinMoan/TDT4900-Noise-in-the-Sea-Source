"""
This file was copied from this repo https://github.com/zcaceres/spec_augment
by github user zcaceres.
Specifically this file: https://github.com/zcaceres/spec_augment/blob/master/exp/nb_SparseImageWarp.py
The only changes I have made are changing the deprecated method torch.solve to the new method torch.linalg.solve.
And to update all calls to torch.meshgrid to include default indexing argument to avoid deprecation warning
TODO: Cite/License properly
"""

import torch
import torch.linalg

def time_warp(spec: torch.Tensor, W=50):
