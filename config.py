...
_FINE_GRAINED_CSV_FILENAME = "fine_grained_labels.csv"
FINE_GRAINED_LABELS_PATH = _PARSED_DIRECTORY.joinpath(_FINE_GRAINED_CSV_FILENAME)
...
_RAW_FINEGRAINED_LABELS_FILENAME = "raw_fine_grained_labels.csv"
...
RAW_FINEGRAINED_LABELS_PATH = _RAW_FILES_DIRECTORY.joinpath(_RAW_FINEGRAINED_LABELS_FILENAME)
